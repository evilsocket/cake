#!/bin/bash
# prepare.sh — One-time setup for model transfer autoresearch.
#
# Usage: bash autoresearch/network/model-transfer/prepare.sh
...
echo "========================================"
echo "  Cake Autoresearch — Model Transfer"
echo "========================================"
echo ""
