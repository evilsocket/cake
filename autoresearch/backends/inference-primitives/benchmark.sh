#!/bin/bash
# benchmark.sh — Fixed harness for inference primitives autoresearch.
# DO NOT MODIFY. This is the ground truth measurement.
#
# Measures: All 16 ComputeBackend inference primitive methods.
# Metric: total benchmark wall-clock time in nanoseconds (lower is better).
#
# Usage: bash autoresearch/backends/inference-primitives/benchmark.sh
