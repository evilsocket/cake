#!/bin/bash
# prepare.sh — One-time setup for attention kernel autoresearch.
#
# Usage: bash autoresearch/kernels/attention/prepare.sh
...
echo "========================================"
echo "  Cake Autoresearch — Attention Kernels"
echo "========================================"
echo ""
...
echo "  Saved to: autoresearch/kernels/attention/baseline.txt"
echo "  TSV: autoresearch/kernels/attention/experiments.tsv"
echo "========================================"
echo ""
