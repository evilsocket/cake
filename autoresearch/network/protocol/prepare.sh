#!/bin/bash
# prepare.sh — One-time setup for network protocol autoresearch.
# Builds the project, runs baseline benchmarks, initializes experiment log.
#
# Usage: bash autoresearch/network/protocol/prepare.sh
...
echo "========================================"
echo "  Cake Autoresearch — Network Protocol"
echo "========================================"
echo ""
...
echo "  Saved to: autoresearch/network/protocol/baseline.txt"
echo "  TSV: autoresearch/network/protocol/experiments.tsv"
echo "========================================"
echo ""
