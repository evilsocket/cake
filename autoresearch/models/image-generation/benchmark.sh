#!/bin/bash
# benchmark.sh — Fixed harness for image-generation autoresearch.
# DO NOT MODIFY. This is the ground truth measurement.
#
# Measures: FLUX/SD component benchmarks (timestep embed, FP8 linear, VAE, pos embed).
# Metric: total benchmark wall-clock time in nanoseconds (lower is better).
#
# Usage: bash autoresearch/models/image-generation/benchmark.sh
