#!/bin/bash
# prepare.sh — One-time setup for quantization kernel autoresearch.
#
# Usage: bash autoresearch/kernels/quantization/prepare.sh
...
echo "========================================"
echo "  Cake Autoresearch — Quantization"
echo "========================================"
echo ""
...
echo "  Saved to: autoresearch/kernels/quantization/baseline.txt"
echo "  TSV: autoresearch/kernels/quantization/experiments.tsv"
echo "========================================"
echo ""
