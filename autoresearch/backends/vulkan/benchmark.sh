#!/bin/bash
# benchmark.sh — Fixed harness for Vulkan backend autoresearch.
# DO NOT MODIFY. This is the ground truth measurement.
#
# Measures: Vulkan GEMV, GEMM, fused ops, dispatch overhead.
# Requires: Vulkan 1.3+ GPU.
# Metric: total benchmark wall-clock time in nanoseconds (lower is better).
#
# Usage: bash autoresearch/backends/vulkan/benchmark.sh
