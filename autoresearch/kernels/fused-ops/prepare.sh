#!/bin/bash
# prepare.sh — One-time setup for fused-ops kernel autoresearch.
#
# Usage: bash autoresearch/kernels/fused-ops/prepare.sh
...
echo "========================================"
echo "  Cake Autoresearch — Fused Operations"
echo "========================================"
echo ""
...
echo "  Saved to: autoresearch/kernels/fused-ops/baseline.txt"
echo "  TSV: autoresearch/kernels/fused-ops/experiments.tsv"
echo "========================================"
echo ""
