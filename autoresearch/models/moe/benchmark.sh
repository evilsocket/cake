#!/bin/bash
# benchmark.sh — Fixed harness for MoE autoresearch.
# DO NOT MODIFY. This is the ground truth measurement.
#
# Measures: MoE forward pass, expert provider access, MoE block benchmarks.
# Metric: total benchmark wall-clock time in nanoseconds (lower is better).
#
# Usage: bash autoresearch/models/moe/benchmark.sh
...
BENCH_FILTER="moe|expert_provider"
