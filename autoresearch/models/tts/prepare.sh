#!/bin/bash
# prepare.sh — One-time setup for TTS models autoresearch.
# Builds the project with TTS features, runs baseline benchmarks, initializes experiment log.
#
# Usage: bash autoresearch/models/tts/prepare.sh
...
echo "========================================"
echo "  Cake Autoresearch — TTS Models"
echo "========================================"
echo ""
...
# --- Check build ---
echo "Building cake-core with TTS features ($FEATURES)..."
...
echo "  Saved to: autoresearch/models/tts/baseline.txt"
echo "  TSV: autoresearch/models/tts/experiments.tsv"
echo "========================================"
echo ""
