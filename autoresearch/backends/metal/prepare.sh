#!/bin/bash
# prepare.sh — One-time setup for Metal backend autoresearch.
# Requires: macOS with Apple Silicon or Intel GPU.
#
# Usage: bash autoresearch/backends/metal/prepare.sh
...
echo "========================================"
echo "  Cake Autoresearch — Metal Backend"
echo "========================================"
echo ""
...
if [ "$(uname)" != "Darwin" ]; then
    echo "WARNING: Not running on macOS. Metal backend requires macOS."
fi

echo "Building cake-core with Metal..."
...
echo "  Saved to: autoresearch/backends/metal/baseline.txt"
echo "  TSV: autoresearch/backends/metal/experiments.tsv"
echo "========================================"
echo ""
