...
#
# Measures: Disk-backed expert loading, pread I/O, dtype conversion,
#           tensor construction, and provider comparison benchmarks.
# Metric: total benchmark wall-clock time in nanoseconds (lower is better).
#
# Usage: bash autoresearch/models/flash-moe/benchmark.sh
...
BENCH_FILTER="flash_moe|expert_provider|pread"
