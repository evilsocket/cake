#!/bin/bash
# benchmark.sh — Fixed harness for text-inference autoresearch.
# DO NOT MODIFY. This is the ground truth measurement.
#
# Measures: attention, MLP, transformer block, and cache benchmarks.
# Metric: total benchmark wall-clock time in nanoseconds (lower is better).
#
# Usage: bash autoresearch/models/text-inference/benchmark.sh
...
BENCH_FILTER="attention|mlp|transformer_block|cache"
