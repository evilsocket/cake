#!/bin/bash
# prepare.sh — One-time setup for text-inference autoresearch.
# Builds the project, runs baseline benchmarks, initializes experiment log.
#
# Usage: bash autoresearch/models/text-inference/prepare.sh
...
echo "========================================"
echo "  Cake Autoresearch — Text Inference"
echo "========================================"
echo ""
...
echo "  Saved to: autoresearch/models/text-inference/baseline.txt"
echo "  TSV: autoresearch/models/text-inference/experiments.tsv"
echo "========================================"
echo ""
