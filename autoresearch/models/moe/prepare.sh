#!/bin/bash
# prepare.sh — One-time setup for MoE autoresearch.
#
# Usage: bash autoresearch/models/moe/prepare.sh
...
echo "  Saved to: autoresearch/models/moe/baseline.txt"
echo "  TSV: autoresearch/models/moe/experiments.tsv"
echo "========================================"
echo ""
