...
/// ChatML chat history shared by Qwen2, Qwen3.5, and other ChatML-based models.
pub struct ChatMLHistory(Vec<Message>);
...
impl std::ops::Deref for ChatMLHistory {
...
impl std::ops::DerefMut for ChatMLHistory {
...
mod tests {
    ...
    fn test_chatml_encoding() {
        let mut history = ChatMLHistory::new();
