#!/bin/bash
# prepare.sh — One-time setup for CPU backend autoresearch.
# No special hardware required — CPU backend is always available.
#
# Usage: bash autoresearch/backends/cpu/prepare.sh
...
echo "========================================"
echo "  Cake Autoresearch — CPU Backend"
echo "========================================"
echo ""
...
echo "  Saved to: autoresearch/backends/cpu/baseline.txt"
echo "  TSV: autoresearch/backends/cpu/experiments.tsv"
echo "========================================"
echo ""
