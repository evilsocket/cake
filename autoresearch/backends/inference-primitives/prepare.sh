#!/bin/bash
# prepare.sh — One-time setup for inference primitives autoresearch.
#
# Usage: bash autoresearch/backends/inference-primitives/prepare.sh
...
echo "========================================"
echo "  Cake Autoresearch — Inference Primitives"
echo "========================================"
echo ""
...
echo "  Saved to: autoresearch/backends/inference-primitives/baseline.txt"
echo "  TSV: autoresearch/backends/inference-primitives/experiments.tsv"
echo "========================================"
echo ""
